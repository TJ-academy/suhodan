...
<div id="edit_popup" class="popup">
	...
	<form action="donation_contents_update.do" method="post"
		...
		<div class="form-item">
			<label for="edit_popup_target_amount">목표 금액</label> <input type="number"
				id="edit_popup_target_amount" name="target_amount" required />원
		</div>
		...
		<div class="form-item">
			...
			<input type="file" id="edit_popup_filename" name="File1" accept="image/*" />
			<!-- 현재 이미지 출력 -->
			<div id="current_image_container" style="display:none;">
				<label>현재 이미지: <span id="current_image_name"></span></label>
				<img id="current_image" src="" alt="기부 이미지" width="100" />
			</div>
		</div>
